...
async function seedDatabase() {
    try {
        ...
        const createdUsers = await models_1.User.create([
            {
                name: 'Ava Chen',
        ...
        const createdTeams = await models_1.Team.create([
            {
                name: 'Rocket Runners',
                sport: 'Running',
                members: 6,
        ...
        await models_1.User.findByIdAndUpdate(createdUsers[0]._id, { team: createdTeams[0]._id });
        await models_1.User.findByIdAndUpdate(createdUsers[1]._id, { team: createdTeams[1]._id });
        await models_1.User.findByIdAndUpdate(createdUsers[2]._id, { team: createdTeams[0]._id });
